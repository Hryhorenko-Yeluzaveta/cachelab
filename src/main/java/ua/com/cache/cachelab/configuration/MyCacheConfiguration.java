package ua.com.cache.cachelab.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "ua.com.cache")
public class MyCacheConfiguration {
    ...
    public CacheManager getCacheManager(){
        ...
        var configuration1 = Eh107Configuration.fromEhcacheCacheConfiguration(cacheConfig);
        ...
        var configuration3 = Eh107Configuration.fromEhcacheCacheConfiguration(cacheConfig2);
